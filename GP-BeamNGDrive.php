...
<title>BeamNG Drive · TZS Online</title>
	<?php
							...
							<div class="card-body CardBodyContentBGSetting">
								<div class="row">
									<div class="col-lg-7" align="center" style="margin-bottom: 20px; margin-top: 20px;">
										<img src="image/Game/GP-BeamNGDrive/logo.png?v=<?php echo filemtime('image/Game/GP-BeamNGDrive/logo.png'); ?>" width="50%" height="auto" alt="BeamNGLogo">
									</div>
								...
								<div class="card CardContentBGSetting">
									<div class="card-body CardBodyContentBGSetting">
										...
										<p>
											<li>
												ขั้นต่ำ
													<p style="margin:0;">ระบบปฏิบัติการ : Windows 7 Service Pack 1</p>
													<p style="margin:0;">หน่วยประมวลผล : Desktop Intel i3</p>
													<p style="margin:0;">หน่วยความจำ : แรม 4 GB</p>
													<p style="margin:0;">กราฟิกส์ : NVIDIA® GeForce® GTX 550 TI</p>
													<p style="margin:0;">DirectX : เวอร์ชัน 11</p>
													<p style="margin:0;">หน่วยบันทึกข้อมูล : พื้นที่ว่างที่พร้อมใช้งาน 5 GB</p>
											</li>
										</p>
										<p>
											<li>
												แนะนำ
													<p style="margin:0;">ระบบปฏิบัติการ : Windows 10 64 Bit</p>
													<p style="margin:0;">หน่วยประมวลผล : High-end Intel i5/i7 or High-end AMD 6 Core or better</p>
													<p style="margin:0;">หน่วยความจำ : แรม 8 GB</p>
													<p style="margin:0;">กราฟิกส์ : NVIDIA® GeForce® GTX 780</p>
													<p style="margin:0;">DirectX : เวอร์ชัน 11</p>
													<p style="margin:0;">หน่วยบันทึกข้อมูล : พื้นที่ว่างที่พร้อมใช้งาน 5 GB</p>
											</li>
										</p>
